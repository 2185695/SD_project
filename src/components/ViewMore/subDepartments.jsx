...
function SubDepartments(){
    ...
    useEffect( () => {
        const deptCode = async() => {
            ...
            await axios.post("https://lamp.ms.wits.ac.za/home/s2172765/sub_products.php", { ID: location.state.Number })
    ...
    else if (dept_code === 109 || dept_code === 111 || dept_code === 110 || dept_code === 128 ||dept_code === 129 || dept_code === 131){
        category = "Clothing";
        dept = <Clothing/>;
    }
